...
window.COURSE_TEMPLATES = {
  "Principles of Applied Engineering": {
    ...
    arc: [
      ...
      {unit:"Engineering Systems & Careers (robotics/automation + electrical & mechanical) — EXPLICIT (d)(2),(d)(7),(d)(8)", weeks:3, teks:["(d)(2)","(d)(7)","(d)(8)"], items:["Systems analysis write-up: components/subsystems of a product (inputs/processes/outputs/feedback), incl. open vs. closed systems (feedback = closed loop) — (d)(2) incl. 2C","Basic electronic theory: components, Ohm's law, series/parallel circuits (uses the Khan EE + Circuits resources) — (d)(8) 8D","Sensor-actuator / mechatronics mini-build (light electrical touch)","How automated systems work: control loop / process control / PLC concept — (d)(7)","O*NET career research: robotics technician, controls/automation engineer, mechatronics tech, electrical tech vs. mechanical designer vs. EE — compare education/training pathways (entry-level / military / apprenticeship / community-technical college / university) — (d)(7),(d)(8),(d)(2)E","Careers presentation: include one emerging trend per field (cobots, EV powertrains, etc.) + tie a Fusion motion study to a REAL automated system (deliverable) — (d)(7)D,(d)(8)C"]},
      ...
      {unit:"Python — project-based (coding track)", weeks:6, teks:["(d)(2)","(d)(6)","(d)(11)"], items:["Estimate for now (project-based) — refine once scoped","Python basics: variables, input/output, conditionals, loops","Functions and debugging","Lists, data, and simple file/CSV handling","Turtle or simple-graphics project","Automate-a-task / calculator project","Student-chosen capstone mini-project (design process in code)"]}
    ]
  },
  "Precalculus": {
